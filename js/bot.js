...
function reply(q) {
    if(q==1){
        ...
        var nl = document.createElement("li");
        nl.innerHTML=`click: <a style="color:white; text-decoration:none; border-radius: 3px 12px; background-color: #006666; padding:7px;" href='https://github.com/AABarnawal' target='_blank'>GITHUB</a>        `;
        document.getElementById("txt").appendChild(nl);
    }
    else if(q==4){
